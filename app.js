...
console.log(chalk.blue("\n****Student Management System****\n"));
let myBalance = 0; //It is like a cart, before purchase any course it is zero.
...
const runProgram = async () => {
    ...
    let selectedCourse = "";
    let selectedCourseFee = 0; //before selection of course
    if (answer.CourseType === "Semester Course") {
        ...
        console.log(`\n The fee for ${chalk.green(selectedCourse)} is ${chalk.red(selectedCourseFee)} PKR \n`);
    }
    else {
